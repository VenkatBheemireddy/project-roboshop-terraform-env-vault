...
resource "null_resource" "ansible" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/VenkatBheemireddy/project-roboshop-ansible-env-vault roboshop.yml -e app_name=${var.component} -e ENV=${var.env} -e vault_token=${var.vault_token}"
